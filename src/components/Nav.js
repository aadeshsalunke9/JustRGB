...
export default function Nav() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (isHome) {
        const sections = ['bio', 'showreel', 'work', 'process', 'contact'];
        let currentSec = '';
  ...
  const drawerPortal = mounted && createPortal(
    ...
    >
      <ul className="mobile-nav-links" role="list">
        ...
        <li>
          <Link href="/#showreel" onClick={handleNavLinkClick} className={isLinkActive('/#showreel') ? 'active' : ''}>
            Showreel
          </Link>
        </li>
        <li>
        ...
        {isHome ? (
          <>
            ...
            <ul className="n-links" role="list">
              ...
              <li>
                <Link href="/#showreel" id="nav-showreel" className={`rgb-hover ${isLinkActive('/#showreel') ? 'active' : ''}`} onClick={handleNavLinkClick}>
                  Showreel
                </Link>
              </li>
              <li>
